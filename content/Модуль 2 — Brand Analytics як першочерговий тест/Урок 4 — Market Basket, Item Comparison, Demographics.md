...
Це список тих, хто забрав у нас продаж. Перший Урок — відкрити їхні лістинги і знайти різницю:
- Ціна
...
- [ ] Я знаю, що показує Market Basket Analysis і як використати cross-sell у SP Product Targeting
- [ ] Я розумію різницю між Item Comparison (хто конкурент) і Alternate Purchase (хто забрав продаж)
- [ ] Я можу пояснити, як Demographics впливає на креатив SBV та SD Audience targeting
- [ ] Я знаю формулу target ACoS з урахуванням LTV (repeat rate + avg repeats)
- [ ] Я вмію визначити пріоритетність звітів BA: що дивитись щотижня, що щомісяця, що щокварталу
- [ ] Я розумію, коли cannibalization між власними ASINs видно через Market Basket
