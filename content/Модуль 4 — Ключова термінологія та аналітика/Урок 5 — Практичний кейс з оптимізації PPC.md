...
- [ ] Я можу самостійно порахувати target ACoS з даних Sellerboard (Margin) і PPC Dashboard (BE-ACoS)
- [ ] Я вмію класифікувати топ-10 ST з STR на категорії: негативити / винести в exact / залишити / знизити бід
- [ ] Я можу проаналізувати Placement Report і визначити, який плейсмент палить бюджет, а який конвертує
- [ ] Я розумію логіку «знизити base bid + підсилити ToS modifier» для збереження профітного плейсменту
- [ ] Я можу порахувати max healthy bid за формулою target × AOV × CR і порівняти з поточним
- [ ] Я вмію оформити звіт менеджеру з root causes, action plan і expected results
- [ ] Я знаю, коли не варто воювати з конкурентом бідом на головному ключі
