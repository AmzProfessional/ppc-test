...
<iframe width="100%" height="360" src="https://www.youtube.com/embed/NCB3j4j1QyU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
## 3. Зв'язок з Модулем 3 Урок 4 (harvest structure)

Коли через Cerebro / Competitor Review (Урок 1 цього модуля) знайшли новий релевантний ключ:

1. Додати у **Broad harvest** (Модуль 3 Урок 4).
...
**5.** Через Cerebro знайшли новий релевантний ключ для variation. Як правильно його додати?
- a) Одразу в Exact на всіх child
- b) Спочатку в Broad harvest через parent (якщо generic) або через конкретний child (якщо specific), після 4+ тижнів і ≥2 orders — винести в Exact на child з найвищим CR
- c) Тільки в Auto-кампанію
- d) Не додавати, якщо ключ generic
...
- [ ] Можу пояснити правило «один child per parent в органіці» і як Amazon обирає showcase child
- [ ] Знаю правильну PPC-структуру для варіацій: SP Exact per child (унікальні ключі), SP Broad/Auto на parent-level
- [ ] Розумію, чому дублювання generic ключа на всіх child — це канібалізація бюджету з низьким CR
- [ ] Вмію знайти у Search Term report ST, що крутиться у >1 кампанії, і додати negative у зайвих
- [ ] Знаю цикл harvest для варіацій: Broad → 4+ тижні → ≥2 orders → Exact на child з найвищим CR
- [ ] Можу виконати місячну ревізію variation PPC за чек-листом: showcase check, кампанії на дублі, ST overlap
